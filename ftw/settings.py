# Django settings for ftw project.
...
DATABASE_NAME = 'ftw_db'             # Or path to database file if using sqlite3.
DATABASE_USER = 'user'             # Not used with sqlite3.
DATABASE_PASSWORD = 'user'         # Not used with sqlite3.
...
SECRET_KEY = '*r#f(lr3=h**o)s69q=qmv+i9$p5#tz#k7(n6clavoq@!)#-u8'
